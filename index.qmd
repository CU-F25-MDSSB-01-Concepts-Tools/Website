...
You have modules with the same names in your program and also the instructors are the same, but the Modules are different! Look it up in your [DSSB (online) handbook](https://constructor.university/sites/default/files/2024-06/DSSB_MSc_2024.pdf). Most importantly, your course will give you more ECTS, so do NOT count on the passing and grading requirements communicated here, they are not valid for you!
...
[Update Nov 10, 2024: **Specification of module passing requirement for Data Science Tools!** (See below.)]{style='color:red;'} 
...
Location: **East Hall 2** in-person  
*Video streaming* (self-organized) in Microsoft Teams provided for late-arriving students: Team **F24_MDSSB-DSOC-02_Data Science Concepts**, General Channel 

**Data Science Tools:**   
Thursday **09:45-11:00** and **11:15-12:30**    
Location: **see campusnet** in-person  
*Video streaming* (self-organized) in Teams provided for late-arriving students: Teams **F24_MDSSB-MET-01-A_Data Science Tools in R** and **F24_MDSSB-MET-01-B_Data Science Tools in python**, General Channel
...
Student Assistants: *to be updated when contracted*
...
**Bonus option:** Students receive **0.33 points** grade improvements on their project grade on the numerical grade as specified in the [Grading Table](https://constructor.university/sites/default/files/2023-02/Grading_Table_2023.pdf) when all assignments are solved by the end of the semester.  (Note, the bonus is not necessary to reach the best grade in the module.)

All assignments and the final project must be delivered in personalized repositories in the [GitHub organization](https://github.com/CU-F24-MDSSB-01-Concepts-Tools).


[Update Nov 10, 2024:]{style='color:red;'}
...
We instructors encourage exploring AI tools for these purposes: 
  ...
  - **Have a draft text snippet written.** Formulating and describing research questions, describing data, documenting code, interpreting results, and deriving conclusion form the results is an essential part of data science. Chatbots are good in writing text which appears well readable. You can use this to inspire you and to polish and improve your texts. However, you are 100% accountable for the text you deliver. You are expected to know what your text is about and to be able to answer questions about what your text means! With text generated purely by chatbots, it is often evident for us that students do not understand. We consider such cases worse than incomplete but sensible self-written text. Text written by chatbots is often very generic and not specific. In general, we value more specific text higher than generic text. [Long generic text is considered **worse** than a shorter more specific text.]{style='color:red;'} 
