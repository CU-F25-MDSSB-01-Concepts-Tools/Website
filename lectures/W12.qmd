---
title: "W#12: Hypothesis Testing, Probability"
author: Jan Lorenz
format: 
  revealjs: 
    toc: true
...
**Can we make a randomized controlled trial (RCT) (gold standard for causal analysis)?**

No. That does not work practicall, and may be even not ethical. We need to have the power to have a random sample of all patients and then assign some of them to the consultant and some not. 
