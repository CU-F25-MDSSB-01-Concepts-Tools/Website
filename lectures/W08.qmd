...
Equation:   
average `flipper_length_mm` $= 190 + 5.87\cdot$ `speciesChinstrap` $+ 27.2\cdot$ `speciesGentoo`
...
The command `glance` shows summary statistics of model fits. 


**Interpretation R-squared?** [75.9% of the variance of flipper length can be explained by a linear relation with body mass.   
Warning: With "explain" we do not claim that there is a causal relation ship.]{.fragment}
