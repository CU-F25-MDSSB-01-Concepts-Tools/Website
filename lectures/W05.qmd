...
if (!file.exists("data/galton.csv")) {
  download.file(
    url = "https://raw.githubusercontent.com/CU-F24-MDSSB-01-Concepts-Tools/Website/refs/heads/main/data/galton.csv",
    destfile = "data/galton.csv"
  )
}
if (!file.exists("data/Viertelfest.csv")) {
  download.file(
    url = "https://raw.githubusercontent.com/CU-F24-MDSSB-01-Concepts-Tools/Website/refs/heads/main/data/Viertelfest.csv",
...
#| fig-height: 2.5
viertel <- read_csv("data/Viertelfest.csv")
viertel |> filter(Schätzung<100000) |> ggplot(aes(`
Schätzung
...
Schätzung
`)) + geom_histogram(binwidth = 500) + 
 geom_vline(xintercept = quantile(viertel$`
Schätzung
`, prob = seq(0, 1, by = 0.25))[1:4], color = "red")
```
