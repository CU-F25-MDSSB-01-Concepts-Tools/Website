---
title: "W#10: Overfitting, Clustering Algorithms, Bias and Variance in Crowd Wisdom"
author: Jan Lorenz
format: 
  revealjs: 
    smaller: true
...
- All *estimates* are made to predict the same value: the truth. 
  - In contrast to the regression model, the estimates come from people and not from a regression formula.
...
- This was a simple demonstration of the difference of error through bias and variance and how the average individual error can be decomposed into the two components
- This topic is deeply related to overfitting in Statistical Learning under the name **Bias-Variance tradeoff**
