...
- For [R](https://cloud.r-project.org/), [positron](https://positron.posit.co/), and [git](https://git-scm.com/downloads) you find instructions on the websites and help in "Data Science Tools"
